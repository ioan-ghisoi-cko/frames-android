...
public class DataStoreTests {
    ...
    public void get_urls() {
        assertEquals("https://sandbox.checkout.com/api2/v2/tokens/card/", mDataStore.getCardEnvSandbox());
        assertEquals("https://api2.checkout.com/v2/tokens/card/", mDataStore.getCardEnvLive());
        assertEquals("https://sandbox.checkout.com/api2/v2/tokens/card/", mDataStore.getGoogleEnvSandbox());
        assertEquals("https://api2.checkout.com/v2/tokens/card/", mDataStore.getGoogleEnvLive());
    }
