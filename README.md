...
dependencies {
 ...
 implementation 'com.github.ioan-ghisoi-cko:frames-android:v0.1.2'
}
```

> You can find more about the installation [here](https://jitpack.io/#ioan-ghisoi-cko/frames-android/v0.1.2)
